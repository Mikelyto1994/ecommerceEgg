...
class Product {
    //constructor
    constructor(id, title, price, stock, photo, onsale, supplier, colors, description, taxPolicy, isFavorite) {
        this.id = id;
        this.title = title ;
        this.price = price;
        this.stock = stock;
...
const product1 = new Product("001", "Macbook Pro 15'4", 750000, 20, ["./assets/mock2.jpg", "./assets/mock2.jpg", "./assets/mock2.jpg"], "50% Off", "Mac", ["black","white"], "Space Gray", "Incluye impuesto País y percepción AFIP",false);
